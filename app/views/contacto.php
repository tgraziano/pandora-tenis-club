<main class="flex flex-col flex-1 px-[20px] md:px-[40px] lg:px-[190px] gap-12 py-14 h-full w-full">
  ...
  <section class="flex justify-between flex-wrap h-full gap-4">
    <article class="flex h-full w-full min-w-[350px] max-w-[500px]">
      <?php include 'forms/contact.php'; ?>
    </article>
    <article class="flex flex-col gap-4 h-full w-full max-w-[600px]">
      ...
      <iframe class="max-w-[600px] w-full h-[350px]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d34072.81311845898!2d-58.49984899976976!3d-34.59868916566126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcc7495c12317d%3A0x8cea287955f0596b!2sPepe!5e0!3m2!1ses!2sar!4v1763254245033!5m2!1ses!2sar" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </article>
  </section>
</main>